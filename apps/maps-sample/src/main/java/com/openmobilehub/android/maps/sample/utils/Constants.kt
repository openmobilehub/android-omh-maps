...
object Constants {
    ...
    const val AUTHORITY_URL = "com.openmobilehub.android.maps.sample"
    ...
    const val AZURE_PROVIDER = "AzureMaps"
    val ALL_PROVIDERS = listOf(GOOGLE_PROVIDER, OSM_PROVIDER, MAPBOX_PROVIDER, AZURE_PROVIDER)
}
