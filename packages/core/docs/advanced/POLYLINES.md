...
Many properties can be set. To get the full list of properties, see the [OmhPolylineOptions](TODO: Add link to OmhPolylineOptions) class.
...
To get the full list of methods, see the [OmhPolyline](TODO: Add link to OmhPolyline) class. Example of usage of `OmhPolyline` methods:
